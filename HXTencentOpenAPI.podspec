#
#  Be sure to run `pod spec lint LBBTencentOpenAPI.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   This pod is used who want to use tencentOpenAPI v3.2.2 with podfile.
                       DESC
  ...
  s.source       = { :git => 'https://github.com/Archera/HXTencentOpenAPI.git', :tag => '0.0.1' }
  ...
  s.author             = { "liubinbin" => "1062454152@qq.com" }
  # Or just: s.author    = "liubinbin"
  # s.authors            = { "liubinbin" => "liubinbin@shhxzq.com" }
  # s.social_media_url   = "http://twitter.com/liubinbin"
  ...
  # s.dependency "LBBTencentOpenAPI", "~> 0.0.1"
